  ...
  function ot_type_custom_post_type_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-custom-post-type-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'ot_type_custom_post_type_checkbox_query', array( 'post_type' => $post_type, 'posts_per_page' => -1, 'cat'=>'-15,-21', 'orderby' => 'title', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
  ...
  function ot_type_custom_post_type_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-custom-post-type-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'ot_type_custom_post_type_select_query', array( 'post_type' => $post_type, 'posts_per_page' => -1, 'orderby' => 'title', 'cat'=>'-15,-21', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
  ...
  function ot_type_post_checkbox( $args = array() ) {
    ...
    echo '<div class="format-setting type-post-checkbox type-checkbox ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'ot_type_post_checkbox_query', array( 'post_type' => array( 'post' ), 'posts_per_page' => -1, 'orderby' => 'title', 'cat'=>'-15,-21', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
  ...
  function ot_type_post_select( $args = array() ) {
    ...
    echo '<div class="format-setting type-post-select ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
      ...
      echo '<div class="format-setting-inner">';
        ...
        /* query posts array */
        $my_posts = get_posts( apply_filters( 'ot_type_post_select_query', array( 'post_type' => array( 'post' ), 'posts_per_page' => -1, 'orderby' => 'title', 'cat'=>'-15,-21', 'order' => 'ASC', 'post_status' => 'any' ), $field_id ) );
