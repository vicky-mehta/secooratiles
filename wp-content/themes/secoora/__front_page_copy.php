...
get_header(); ?>
    ...
    <section class="collection pt-5 pb-5" id="product">
    	<div class="container wow fadeInUp">
        	<h1 class="text-white text-center h1style1"><span><font class="f-bold">SECOORA</font> Collection 2020</span></h1>
                	...
                	<div class="row">
                        <div class="col-md-12 col-lg-12 wow rotateInDownRight">
                            <div class="product-cat-item mt-5">
                                <a target="_blank" href="http://www.secooratiles.in/wp-content/uploads/SECOORA-ROOFTILES.pdf">
